...
function AddProject({ setNewTask, title }) {
  ...
  return (
    <div className="flex items-center gap-3 my-2">
      ...
      <div className="relative inline-block text-left w-2/3 px-4">
        <div>
          <button onClick={toggleProjects} type="button" className="inline-flex w-full rounded-md py-2 bg-white text-grey-500 hover:bg-grey-200">
